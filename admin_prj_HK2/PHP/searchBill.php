<?php
    ...
    for ($i=0; $i <count($data) ; $i++) { 
        $temp = "<div class=\"col\" id=\"col-bill\" > <a id=\"set-bill\"  class=\"delete\" onclick=\"EditCT('".$data[$i]['IdHoaDon']."') \"><i class=\"fas fa-info-circle\"></i></a> <a  class=\"delete\" onclick=\"setBill('".$data[$i]['IdHoaDon']."')\"><i class=\"fas fa-check-double\"></i></a>    
