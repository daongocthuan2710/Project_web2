<?php
    ...
    for ($i=0; $i <count($data) ; $i++) { 
        $temp = "<div class=\"col\"> <a  class=\"delete\" onclick=\"deleteNV(".$data[$i]['idnv'].")\"><i class=\"fas fa-trash-alt\"></i></a> <a class=\"edit\" onclick=\"document.getElementById('form-signin').style.display='block'\"><i class=\"fas fa-edit\"></i></a>
