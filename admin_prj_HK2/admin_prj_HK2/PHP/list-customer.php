...
<div id="customer-result">
        ...
        <?php
            ...
            for ($i=0; $i <count($data) ; $i++) { 
                $temp = "<div class=\"col\"> <a  class=\"delete\" onclick=\"document.getElementById('form-accept-delete-product').style.display='block'\"><i class=\"fas fa-trash-alt\"></i></a> <a class=\"edit\" onclick=\"document.getElementById('form-edit-noti-humman').style.display='block'\"><i class=\"fas fa-edit\"></i></a>
