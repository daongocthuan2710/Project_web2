<div id="main" class="main">
        ...
        <div class="container"> 
            <div id="banner" class="row">
                <div class="col-lg-8 col-md-6 col-sm-6">
                    <div id="banner_main" >
                        <div><h1>BANER THỂ LOẠI 1</h1></div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div id="banner_thumb">
                        <div class="col banner_thumb1" >BANER THỂ LOẠI 1</div>
                        <div class="col banner_thumb1" >BANER THỂ LOẠI 1</div>
                        <div class="col banner_thumb1" >BANER THỂ LOẠI 1</div>
                    </div>
                </div>
        ...
        <div class="container"> 
            <div id="banner" class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div id="banner_main" >
                        <div><h1>BANER THỂ LOẠI 2</h1></div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div id="banner_main" >
        ...
        <div class="container"> 
            <div id="banner" class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div id="banner_main" >
                        <div><h1>BANER THỂ LOẠI 3</h1></div>
                    </div>
                </div>
            </div>
    ...
    <div class="main_banner">
        <div class="col-md-12 col-sm-12">
            <img id="img1" onclick="changeImage()" src="img/banner3.jpg" alt="" />
        </div>
    </div>
    ...
    <div id="content1" class="content">
        <div class="container"> 
            <div id="banner" class="row">
                <div class="col-lg-8 col-md-6 col-sm-6">
                    <div id="banner_main" >
                        <div><h1>BANER THỂ LOẠI 4</h1></div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div id="banner_thumb">
                        <div class="col banner_thumb1" >BANER THỂ LOẠI 4</div>
                        <div class="col banner_thumb1" >BANER THỂ LOẠI 4</div>
                        <div class="col banner_thumb1" >BANER THỂ LOẠI 4</div>
                    </div>
                </div>
        ...
        <div class="container"> 
            <div id="banner" class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div id="banner_main" >
                        <div><h1>BANER THỂ LOẠI 5</h1></div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div id="banner_main" >
        ...
        <div class="container"> 
            <div id="banner" class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div id="banner_main" >
                        <div><h1>BANER THỂ LOẠI 6</h1></div>
                    </div>
                </div>
            </div>
